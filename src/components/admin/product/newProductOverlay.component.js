...
export const NewProductOverlay = ({ show, callbackShowProduct, onSuccessNewProduct }) => {
  ...
  const closeOverlay = () => {
    ...
    photos.length > 0 && photos.forEach(async (elementos) => {
  ...
  return show && <div className="product-overlay-container">
    <section className="product-overlay-section">
      ...
      <BiX className="close-overlay-product" onClick={() => closeOverlay()} size={50} />
...
export default NewProductOverlay;